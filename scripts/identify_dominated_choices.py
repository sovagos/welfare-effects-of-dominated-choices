...
for program in programs.values():
    dual_self_funded_program_dictionary.update(
        program.create_self_funded_program_dictionary()
    )
...
for applicant in applicants.values():
    applicant.correct_dominated_dropping_lower_bound(
        applicant.ranking,
        applicant.priority_scores,
        dual_self_funded_program_dictionary,
    )
    applicant.add_dominated_dropping(
        dual_self_funded_program_dictionary, applicant.ranking_lower_bound
    )
    applicant.add_dominated_flipping(
        dual_self_funded_program_dictionary, applicant.ranking_lower_bound
    )
