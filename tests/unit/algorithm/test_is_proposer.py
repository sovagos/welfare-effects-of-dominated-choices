...
from tests.unit.algorithm.helpers import create_applicant, create_admitted_applicant_status, \
    create_rejected_applicant_status, create_application
...
def test__is_proposer__when_applicant_is_rejected_but_ranking_is_not_exhausted__returns_true():
    applicant = create_applicant({"ranked_applications": [create_application(), create_application()],
